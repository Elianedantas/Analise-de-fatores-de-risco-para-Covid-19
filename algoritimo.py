...
def Treinar(Asma,Cardiopatia,Diabetes,Doenca_Hepatica,Doenca_Neurologica,Doenca_Renal,Idade,Obesidade,Pneumopatia):
    dadosT = normalizarDados(base_Treinamento)
    diagnostico_norm = base_Treinamento[:, 9]
    modelo = treinarRedeKNN(dadosT,diagnostico_norm)
    
    teste = [[Asma,Cardiopatia,Diabetes,Doenca_Hepatica,Doenca_Neurologica,Doenca_Renal,Idade,Obesidade,Pneumopatia]]
